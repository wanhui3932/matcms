					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="position_id">
								<?php if(is_array($pisitions)): $i = 0; $__LIST__ = $pisitions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$position): $mod = ($i % 2 );++$i;?><option value="<?php echo ($position['id']); ?>"><?php echo ($position['name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
