              ...
              <table class="table table-bordered table-hover singcms-table">
                ...
                <tbody>
                  <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><?php echo (str_ireplace($search,"<font color='#ff000'>$search</font>",$new[title])); ?></td>
                      ...
                      <td>
                        ...
                        &nbsp;
                        <span class="sing_cursor glyphicon glyphicon-remove-circle" id="singcms-delete" attr-message="删除" aria-hidden="true" attr-id="<?php echo ($new['news_id']); ?>"></span>
                      </td>
