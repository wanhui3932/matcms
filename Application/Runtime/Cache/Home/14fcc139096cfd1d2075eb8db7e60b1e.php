...
<div class="strip">
     ...
     <div class="search">
            <form action="" method="post">
                <input type="text" value="<?php echo ($search); ?>" placeholder="Search..." name="search">
                <input type="submit" value="">
            </form>
     </div>  

      <?php if($_SESSION['userInfo']['username']): ?><div class="social">  
              <span class="btn btn-primary" data-toggle="modal" data-target="#userInfo">欢迎回来：<?php echo ($_SESSION['userInfo']['username']); ?></span>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="recipient-name" class="control-label">用户名：</label>
            <input type="text" class="form-control" name="signinusername" value="<?php echo ($_SESSION['userInfo']['username']); ?>" disabled>
          </div>
         
          <div class="form-group" id="#asd">
            <label for="message-text" class="control-label">昵称：</label>
            <input type="text" class="form-control" name="editrealname" value="<?php echo ($_SESSION['userInfo']['realname']); ?>">
          </div>
          <div class="form-group" id="#email">
            <label for="message-text" class="control-label">邮箱：</label>
            <input type="text" class="form-control" name="editemail" value="<?php echo ($_SESSION['userInfo']['email']); ?>">
          </div>
        </form>
      </div>
      <div class="modal-footer">
...
<div class="about">
     ...
     <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="about-grids">
             <h3 style="width: 500px;"><a href="/index.php?c=detail&id=<?php echo ($vo['news_id']); ?>&catid=<?php echo ($vo['catid']); ?>" style="font-size: 24px;"><?php echo ($vo["title"]); ?></a></h3>
